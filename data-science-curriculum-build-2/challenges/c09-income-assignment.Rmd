...
- Document your observations here.
  - The categories with greatest confidence intervals appear to be 5-person and 6-person family incomes
  - The categories with the smallest confidence intervals appear to be the 2-person and 3-person family incomes
  
  
- Can you confidently distinguish between household incomes in Suffolk county? Why or why not?
  - It is hard to distinguish between household incomes in Suffolk county as they are quite close together on the plot. 
  
- Which counties have the widest confidence intervals?
  - The counties with the widest confidence intervals are Dukes and Nantucket
...
- What *overall* trend do you see between `SE` and population? Why might this trend exist?
  - I notice that the greater the population, the lower the SE, and the smaller the population,
    the higher the SE
  - This trend may exist because of the inverse relationship between standard error and sample 
  size. Since populations are effectively whole samples, the greater a population the more 
  accurate our data about it becomes.
  
- What does this *overall* trend tell you about the relative ease of studying small vs large counties?
  - Studying smaller counties is more difficult to study as there is less data about them and thus 
    less accurate conclusions can be drawn. 
...
Question: How does the population size of a county affect the difference in estimated income between family sizes?
...
- Counties with larger populations seem to have a higher mean income across all family sizes than other county population sizes
- Smaller counties seem to have a smaller range of incomes than all other county population sizes
- All the counties seem to share the trait that 4-person family households have slightly higher mean income
