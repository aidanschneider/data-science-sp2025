...
- What *Category* of variable is `avg_T`? Why is it such an effective
  ...
  - It is an effective predictor as it takes the average temperature
    across a plane, which is heavily correlated with the other variables
    we are considering, x and T_norm, as x is position and T_norm is
...
- How do these standard deviations relate to the regression coefficients
  for `x` and `T_f`?
  - These values both indicate how influential a variable is on the
    model
...
# Note: I was not able to finish this one as I was had a hard time understanding
# this process. I would like some help on this in class if possible. 
```
