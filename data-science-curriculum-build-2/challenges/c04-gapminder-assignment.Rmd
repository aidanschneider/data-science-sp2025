...
I chose to make a box plot to compare the range of GDP Per Capita of each continent. The above plot shows that the GDP Per Capita varies significantly by continent, with Asia and Africa having the lowest GDP Per Capita's on average and Oceania and Europe having the highest GDP Per Capita's on average. There are also some outlier countries for the Americas boxplot and the Asia boxplot.
