...
assertthat::assert_that(
              (df_q3 %>%
              filter(str_detect(Geographic.Area.Name, "Autauga County")) %>% #Note: changed "Geographic Area Name" to "Geographic.Area.Name" to
              pull(fips)) == "01001"                                         # to reflect actual column name
            )
```
