...
Difference: one follows tidy convention by using pipe operators, the other does not. 
...
Before uncommenting: gives mean price of all diamonds
After uncommenting: gives the mean price of each grouping of color and clarity of diamonds. 
